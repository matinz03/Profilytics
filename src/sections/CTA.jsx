    ...
    <PageWrapper>
      <div className="flex flex-col items-center justify-center min-h-screen text-center">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="p-8 rounded-2xl bg-gradient-to-br from-[#1e46b4] via-[#0f6efc] to-[#0f172a] text-white font-semibold shadow-xl hover:brightness-110 flex flex-col items-center gap-6"
        >
